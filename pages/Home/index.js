...
const HomeMain = () => {
  ...
  const { countries, errorData } = useSelector((state) => state.countryReducer)
  ...
  const OmniliteTest = () => {
    ...
    if (errorMessage) {
      ...
      window.localStorage.setItem('account', JSON.stringify(omnilite.data.meta))
  ...
  const acctTest = () => {
    ...
    if (errorMessages === 'Account already exists with the phone') {
      ...
      window.localStorage.setItem('account', JSON.stringify(accountNumber.data))
    }
  }
  useEffect(() => {
    acctTest()
      ...
      <section className={styles.secondSection}>
        <div className={styles.secondSectionHeader}>
          <div className={styles.secondSectionHeaderText}>
            ...
            <p>Get onboard and have access to unlimited possibilites.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
            <div className={styles.existingUser}>
              <div className={styles.existingUserHeader}>
                <p className={styles.choose}>Choose Preferred Login Option</p>
