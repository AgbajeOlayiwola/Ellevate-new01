...
export const loadCountry = () => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(countryLoadError(error.response.data.message)))
}
//country actions end
...
export const statesData = () => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(statesLoadError(error.response.data.message)))
}
//states actions end
...
export const loadbillerCategory = (code) => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(billerCategoryLoadSuccess(response.data.data)))
...
export const postAirtime = (billerdata) => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(airtimeLoadError(error.response.data.message)))
}
...
export const postBills = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(billsLoadError(error.response.data.message)))
}
...
export const postInternalBank = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(internalBankLoadSuccess(response.data.data)))
...
export const getBalanceEnquiry = () => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(balanceEnquiryLoadSuccess(response.data.data)))
...
export const getBulkTransfer = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(bulkTransferLoadSuccess(response.data.data)))
    .catch((error) =>
...
export const getInternationalTransfer = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(internationalTransferLoadError(error.message)))
}
...
export const getVerifyCurrency = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(verifyCurrencyLoadSuccess(response.data.data)))
...
export const omniliteData = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(omniliteLoadError(error.response.data.message)))
}
...
export const cardLoginData = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .catch((error) => dispatch(cardLoginLoadError(error.response.data.message)))
}
...
export const existingUserProfileData = (data) => (dispatch) => {
  ...
  axiosInstance
    ...
    .then((response) => dispatch(existingUserProfileLoadSuccess(response.data)))
    .catch((error) =>
...
export const createProfileSetup = (profileData) => {
  ...
  return async (dispatch) => {
    await axios
          ...
          axiosInstance
            ...
            .then((response) => {
              ...
              if (
                ...
                dispatch(bvnNinError(null)), dispatch(bvnNinErrorI(null))
              }
            })
            .catch((error) => {
      ...
      .catch((error) => {
        console.log('profile setup dispatch', error.response.data.message)
  ...
  return (dispatch) => {
    ...
    axiosInstance
      ...
      .catch((error) => {
        console.log(error)
        dispatch(
          completeProfileLoadError('error check the fields and try again'),
        )
      })
  }
}
  ...
  return (dispatch) => {
    ...
    axiosInstance
      ...
      .catch((error) => {
        ...
        dispatch(createNewCorpAccountError(error.response.data.message))
      })
  }
}
